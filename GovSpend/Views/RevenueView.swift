                            ...
                            VStack (spacing: 25){
                                ...
                                if let taxRevenue = taxRevenue.revenue.first, let nonTaxRevenue = nonTaxRevenue.nonTaxRevenue.first {
                                    VStack (spacing: 10) {
                                        ...
                                        Text(AppSettings.convertToDollars(someDouble: Double(taxRevenue.net_collections_amt)!))
                                            .font(.system(size: 12))
                                            .padding(.bottom, 3.0)
                                        
                                        Text("Non-Tax Revenue")
                                            .font(.system(size: 12)).fontWeight(.semibold)
                                        Text(AppSettings.convertToDollars(someDouble: Double(nonTaxRevenue.net_collections_amt)!))
                                            .font(.system(size: 12))
